...
Sub RamMuncher()
    ...
    For Each ws In Worksheets
        ...
        Dim TableRow As Integer
            TableRow = 2
        'Non static ending value for loops becuase each sheet has different amounts of rows "Source 1 in ReadMe"
        ...
        For n = 2 To EndRow
            ...
            If ws.Cells(n + 1, 1).Value <> ws.Cells(i, 1).Value Then
              ...
              'format range to percentages with 2 decimals "Source 2 in ReadME"
    ...
    'Conditionally format the yearly change column "Source 3 in ReadME"
